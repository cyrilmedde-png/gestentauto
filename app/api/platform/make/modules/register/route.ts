...
/**
 * API pour enregistrer un nouveau module créé par Make
 * POST /api/platform/make/modules/register
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Erreur dans /api/platform/make/modules/register:', error)
    return NextResponse.json(
