    ...
    <>
      ...
      >
        <div className="bg-background/50 backdrop-blur-sm">
          <div className={`${isMobile ? 'container mx-auto px-4' : 'px-6'} py-3 sm:py-4`}>
            <div className="flex items-center justify-between gap-2 sm:gap-4">
              {/* Search */}
              <div className="flex-1 min-w-0 max-w-md">
                <div className="relative">
                  <Search className="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground pointer-events-none" />
                  <input
                    type="text"
                    placeholder="Rechercher..."
                    className="w-full pl-8 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-2.5 text-sm sm:text-base bg-transparent border border-border/50 rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
              </div>
